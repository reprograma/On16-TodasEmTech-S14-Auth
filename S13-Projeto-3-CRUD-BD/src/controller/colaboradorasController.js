...
const create = (req, res) =>{
    const senhaComHash = bcrypt.hashSync(req.body.senha, 10)// pedir pro bcrypt hashear a senha
    req.body.senha =senhaComHash // atualizar o body com a senha hasheada
